        ...
        return (
            <div className="SignupMain">
                <div className="SignupCard">
                    <h1>Connexion</h1>
                    {error ? <p style={{color:'red'}}>{error.message}</p> : <p></p>}
                    ...
                    <div  class="google-button card" onClick={this.loginFacebook}>
                        <span class="google-button__icon google-button__icon--plus">
                            ...
                            <span class="google-button__text">Connexion Avec Facebook</span>
                    </div>
                </div>
                <div className="Signup_form card" onSubmit={this.handleSubmit}>
                    <form >
                        ...
                        <div>
                            <a><NavLink to="/resetpassword">Mot de passe oublié ?</NavLink></a>
